...
def execute_query(option):
  if option == 0:
    ...
    plot_lit   = True
    plot_field = True
    pc.setup_and_plot_vars(0,cwdpath,csv_destination,plot_lit,plot_field)
  elif option == 8:
    plot_lit   = False
    plot_field = False
    pc.setup_and_plot_vars(1,cwdpath,csv_destination,plot_lit,plot_field)
  elif option == 9:
    plot_lit   = False
    plot_field = False
    pc.setup_and_plot_vars(2,cwdpath,csv_destination,plot_lit,plot_field)
