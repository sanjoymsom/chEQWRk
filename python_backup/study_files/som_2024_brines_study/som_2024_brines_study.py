...
def ask_questions():
  print(51*'-')
  print('           chEQWRk - Som et al. in review ')
  print(51*'-')
...
def check_EQ36():
  ...
  if does_eq36_exist:
    ...
    print('EQserp needs EQ3/6 installed at root.  It was not found.   See READ.me.')
    print('If it is installed, edit PATH of eqpath variable in executor.py (l.30).')
    sys.exit()
#######################################################################
# EXEC FUNCTIONS
#######################################################################
...
def zip_and_save():
  ...
  os.system('mv '+output_filename+'.'+zip_format+' saved_files')
